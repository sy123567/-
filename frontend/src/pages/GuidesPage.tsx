...
export function GuidesPage() {
  ...
  const resetFilters = () => { setCategory("全部"); setQuery(""); setCityFilter("all"); setDaysFilter("all"); setSortBy("rating"); };
